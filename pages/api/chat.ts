...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const systemPrompt = [
    ...
    '4. If catalog has no good match, suggest outside shoes using SEARCH URLs only (never direct product URLs - they go stale):',
    '{{EXTERNAL:[{"name":"Nike Pegasus 41","brand":"Nike","reason":"Great for neutral runners","url":"https://www.nike.com/search?q=pegasus+41","price_range":"$130-$150"}]}}',
    'Search URL formats: Nike=https://www.nike.com/search?q=NAME, Adidas=https://www.adidas.com/us/search?q=NAME, NewBalance=https://www.newbalance.com/search?q=NAME, Puma=https://us.puma.com/en/search?q=NAME. Spaces become +.',
