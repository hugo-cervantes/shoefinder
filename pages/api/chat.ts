...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const systemPrompt = [
    ...
    '4. If catalog has no good match, suggest outside shoes at end of message:',
    '{{EXTERNAL:[{"name":"Nike Pegasus 41","brand":"Nike","reason":"Great for neutral runners","url":"https://www.nike.com/t/pegasus-41","price_range":"$130-$150"}]}}',
