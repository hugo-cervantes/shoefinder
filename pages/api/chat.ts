...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const systemPrompt = [
    ...
    '{{EXTERNAL:[{"name":"Nike Pegasus 41","brand":"Nike","reason":"Great for neutral runners","url":"https://www.google.com/search?q=Nike+Pegasus+41","price_range":"$130-$150"}]}}',
    'URL format: https://www.google.com/search?q=BRAND+SHOE+NAME (spaces become +). Just a regular Google search for the shoe name so the user can pick any site they want.',
